...
var AddonModImscpIndexPage = /** @class */ (function () {
    ...
    AddonModImscpIndexPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-addon-mod-imscp-index',template:/*ion-inline-start:"/home/michael/Desktop/moodlemobiledirectory/src/addon/mod/imscp/pages/index/index.html"*/'<ion-header>\n    <ion-navbar core-back-button>\n        <ion-title><core-format-text [text]="title"></core-format-text></ion-title>\n\n        <ion-buttons end>\n            <!-- The buttons defined by the component will be added in here. -->\n        </ion-buttons>\n    </ion-navbar>\n</ion-header>\n<ion-content>\n    <addon-mod-imscp-index [module]="module" [courseId]="courseId" (dataRetrieved)="updateData($event)"></addon-mod-imscp-index>\n</ion-content>\n'/*ion-inline-end:"/home/michael/Desktop/moodlemobiledirectory/src/addon/mod/imscp/pages/index/index.html"*/,
        }),
